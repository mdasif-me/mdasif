  ...
  return (
    <section className="space-y-8 py-12 mt-40 container mx-auto px-4 md:px-6 lg:px-8">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        {/* Hero Skeleton */}
        <div className="relative h-[400px] overflow-hidden rounded-2xl md:h-[550px] lg:col-span-2 bg-gray-200 animate-pulse">
          ...
          <div className="space-y-4">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="flex items-center gap-4 animate-pulse">
                <div className="h-16 w-16 bg-gray-200 rounded-md shrink-0" />
